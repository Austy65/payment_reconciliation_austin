...
# Idempotency:
#   event_id is the primary key. Duplicate event submissions
#   return status="duplicate" without changing transaction state.
# """
...
#     # ---------------------------------------------------------
#     # 2. Create merchant if it doesn't exist
#     # ---------------------------------------------------------
...
#     # ---------------------------------------------------------
#     # 3. Get/create transaction BEFORE creating event
#     # ---------------------------------------------------------
...
#     else:
#         # Only advance the transaction state.
#         if STATUS_RANK.get(new_status, 0) > STATUS_RANK.get(tx.status, 0):
#             tx.status = new_status
#             tx.updated_at = datetime.now(timezone.utc)

#     # ---------------------------------------------------------
#     # 4. Create event AFTER transaction exists
#     # ---------------------------------------------------------
#     event = Event(
#         event_id=payload.event_id,
#         transaction_id=payload.transaction_id,
...
#     # ---------------------------------------------------------
#     # 5. Get all event types for reconciliation
#     # ---------------------------------------------------------
#     event_types_result = db.execute(
#         select(distinct(Event.event_type)).where(
...
#     # ---------------------------------------------------------
#     # 7. Create/update reconciliation record
#     # ---------------------------------------------------------
